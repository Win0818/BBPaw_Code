...
public class InformGlobalDialog extends Dialog {
    private boolean mBlockKeycodeBack = false;

    public InformGlobalDialog(Context context, int theme) {
        super(context, theme);
        mBlockKeycodeBack = false;
    }

    public InformGlobalDialog(Context context) {
        super(context);
    }
    ...
    public static class Builder {
         ...
         * @return
         */
        public InformGlobalDialog create() {
         ...
         * @return
         */
        public InformGlobalDialog create(int style, View dialogContentView) {
            // instantiate the dialog with the custom Theme
        	if (dialogContentView == null) {
        		return null;
        	}
            final InformGlobalDialog dialog = new InformGlobalDialog(context, style);
