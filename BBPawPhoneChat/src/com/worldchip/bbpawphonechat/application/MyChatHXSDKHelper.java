...
import com.worldchip.bbpawphonechat.model.HXNotifier;
import com.worldchip.bbpawphonechat.model.HXNotifier.HXNotificationInfoProvider;
import com.worldchip.bbpawphonechat.model.HXSDKModel;
import com.worldchip.bbpawphonechat.receiver.CallReceiver;
 ...
 * @author easemob
 */
public class MyChatHXSDKHelper extends HXSDKHelper{
    ...
    protected void onCurrentAccountRemoved(){
    	Intent intent = new Intent(appContext, MainActivity.class);
        intent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
        intent.putExtra(MyComment.ACCOUNT_REMOVED, true);
        appContext.startActivity(intent);
    }
    ...
    public Map<String, User> getContactList() {
        if (getHXId() != null ) {
            ...
            Log.e(TAG, "--------DemoHXSDKModel---contactList---------="+contactList);
        }
        return contactList;
    }
