...
//            user.setAvatar("http://downloads.easemob.com/downloads/57.png");
    ...
    public static void setUserAvatar(Context context, String username, ImageView imageView){
        ...
        if(user != null){
            Picasso.with(context).load(user.getAvatar()).placeholder(R.drawable.chat_contact_big_head_default).into(imageView);
        }else{
            Picasso.with(context).load(R.drawable.chat_contact_big_head_default).into(imageView);
        }
    }
