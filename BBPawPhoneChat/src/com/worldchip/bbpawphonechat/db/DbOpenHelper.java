...
public class DbOpenHelper extends SQLiteOpenHelper{
	...
	private static final String USERNAME_TABLE_CREATE = "CREATE TABLE "
			...
			+ UserDao.COLUMN_HEAD_IMAGE_URL + " TEXT, "
			+ UserDao.COLUMN_SETTING_NAME + " TEXT, "
	...
	private  static final String CREATE_HABIT_CONTROL = "CREATE TABLE " 
	                  + HabitDao.TABLE_NAME + " ("
	                  + HabitDao.CODE_ID + " INTEGER, "
	                  + HabitDao.IS_LOCK + " INTEGER); ";
	...
	public void onCreate(SQLiteDatabase db) {
		...
		db.execSQL(CREATE_HABIT_CONTROL);
	}
