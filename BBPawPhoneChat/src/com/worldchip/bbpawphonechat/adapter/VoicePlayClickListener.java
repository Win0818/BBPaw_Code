...
public class VoicePlayClickListener implements View.OnClickListener {
	...
	public void stopPlayVoice() {
		...
		if (message.direct == EMMessage.Direct.RECEIVE) {
			voiceIconView.setImageResource(R.drawable.talk_voice_static_single_other);
		} else {
			voiceIconView.setImageResource(R.drawable.talk_voice_static_single_my);
		}
		// stop play voice
		if (mediaPlayer != null) {
			mediaPlayer.stop();
		...
		isPlaying = false;
		((PhoneChatActivity) activity).playMsgId = null;
	...
	public void playVoice(String filePath) {
		...
		((PhoneChatActivity) activity).playMsgId = message.getMsgId();
	...
	public void onClick(View v) {
		...
		if (isPlaying) {
			if (((PhoneChatActivity) activity).playMsgId != null && ((PhoneChatActivity) activity).playMsgId.equals(message.getMsgId())) {
