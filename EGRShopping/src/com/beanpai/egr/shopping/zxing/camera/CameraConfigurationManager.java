...
package com.beanpai.egr.shopping.zxing.camera;
...
import com.beanpai.egr.shopping.zxing.config.Config;
...
final class CameraConfigurationManager {
	...
	private Point getDisplaySize(final Display display) {
		...
		try {
			// update by zengfantian -- there is no function for [display.getSize(point)] in sdk 2.3.3 
